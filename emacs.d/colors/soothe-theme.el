...
(let  (
  ...
  (unless (window-system)
    (setq background      "#121212")
    (setq background-dark "#121212")
    (setq alt-background  "#121212")
    (setq gray-1bg        "#121212")
    (setq gray-2bg        "#121212")
    (setq gray-3bg        "#121212")
    (setq gray-4bg        "#121212")
    (setq gray-5bg        "#121212")
    (setq gray-6bg        "#121212")
    (setq red-1bg         "#121212")
    (setq red-2bg         "#121212")
    (setq brown-1bg       "#121212")
    (setq orange-1bg      "#121212")
    (setq yellow-1bg      "#121212")
    (setq green-1bg       "#121212")
    (setq green-2bg       "#121212")
    (setq turquoise-1bg   "#121212")
    (setq turquoise-2bg   "#121212")
    (setq blue-1bg        "#121212")
    (setq blue-2bg        "#121212")
    (setq blue-3bg        "#121212")
    (setq blue-4bg        "#121212")
    (setq purple-1bg      "#121212"))
